...
const router=await import(new URL('../static/becoming/router.js?runtime-test=2.17.2',import.meta.url));
const release=await import(new URL('../static/becoming/domain/skill-release.js?runtime-test=2.17.2',import.meta.url));
const contract=await import(new URL('../static/becoming/domain/screen-contract.js?runtime-test=2.17.2',import.meta.url));
...
for(const needle of [
  "./router.js?v=2.17.2",
  "./domain/screen-contract.js?v=2.17.2",
  "./domain/skill-release.js?v=2.17.2",
  "./screens/grammar.js?v=2.17.2",
]){
...
assert.equal(grammar.includes("../router.js?v=2.17.2"),true,'Grammar screen must use current router module');
