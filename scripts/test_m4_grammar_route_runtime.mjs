...
const router=await import(new URL('../static/becoming/router.js?runtime-test=2.15.12',import.meta.url));
const release=await import(new URL('../static/becoming/domain/skill-release.js?runtime-test=2.15.12',import.meta.url));
const contract=await import(new URL('../static/becoming/domain/screen-contract.js?runtime-test=2.15.12',import.meta.url));
...
for(const needle of [
  "./router.js?v=2.15.12",
  "./domain/screen-contract.js?v=2.15.12",
  "./domain/skill-release.js?v=2.15.12",
  "./screens/grammar.js?v=2.15.12",
]){
...
assert.equal(grammar.includes("../router.js?v=2.15.12"),true,'Grammar screen must use current router module');
