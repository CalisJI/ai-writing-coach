...
zh.blocks[1]={id:'insert',type:'insertion',stage:'connect',title:{vi:'Vị trí'},payload:{segments:[
  ...
  {text:'去',pinyin:'qù',role:'action'},
  {text:'过',pinyin:'guo',role:'marker',inserted:true},
...
assert.match(zhHtml,/role-marker/);

const screen=readFileSync(new URL('../static/becoming/screens/grammar.js',import.meta.url),'utf8');
for(const needle of ['grammar-learning.js?v=2.16.0','renderGrammarLearningModel','grammarLearningCompletion','legacyLessonBody']){
