...
assert.match(css,/\.listening-workspace\[data-listening-mode="follow"\] \.listening-transcript\{\s*display:grid[\s\S]*grid-template-rows:auto auto minmax\(0,1fr\) auto/);
