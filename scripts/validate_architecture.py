...
require(version.startswith("0.9."), "VERSION must be v0.9.x")
...
require("writing_coach.languages.english.profile" in app, "English evaluator config must be modular")
...
require("zh" in langs and not langs["zh"].enabled, "Chinese must remain disabled in v0.9")
