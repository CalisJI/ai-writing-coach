...
5. **Protected areas** — did any change? (AGENTS.md §5: Journey, Review, Library
   ...
   page gutter, card padding, section gaps, overflow, width primitives, frontend
   v2.17.3, R5 Grammar contracts and Concept IDs, `docs/visual-references/**`.)
...
12. **Git state** — exact `git status` summary, branch, and commit SHA when
    applicable.
