...
- M1.5 — active Listening: **IN PROGRESS**;
...
backend and internal passive-MVP acceptance. M1.5 is the current Active
Listening checkpoint over the same canonical segments. Neither checkpoint
implies Listening completion or public release.
