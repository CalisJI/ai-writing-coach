...
jest.mock('../../src/query/useHome', () => ({useEssays: () => mockIdleQuery, useLearningMemory: () => mockIdleQuery, useReadingSessionHistory: () => mockIdleQuery, useOpenEssay: () => ({isPending: false, isError: false, mutate: jest.fn()})}));
