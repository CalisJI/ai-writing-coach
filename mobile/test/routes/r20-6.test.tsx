...
const mockGrammarComplete = {isPending: false, isError: false, mutate: jest.fn()};
const mockGrammarLibrary = {isPending: false, isError: false, data: {lessons: [{id: 'en-articles', title: 'Articles', level: 'B1', completed: false}], total: 1, completed: 0, levels: ['B1'], level_names: {B1: 'B1'}, language: 'en'}};
const mockGrammarLesson = {isPending: false, isError: false, data: {id: 'en-articles', title: 'Articles', level: 'B1', completed: false, examples: [{target: 'A learner writes.'}], quick_reference: {rule: 'Use a.'}}};
const mockLibraryQuery = {isPending: false, isLoading: false, isError: false, data: {items: [{word: 'clarity', phonetic: '', part_of_speech: 'noun', definition: 'clear expression', translation_vi: '', added_at: '2026-01-01', source_fragment: '', source_kind: 'manual', focus_note: '', review_stage: 1, stage_label: 'Learning', successful_recalls: 0, lapse_count: 0, last_reviewed_at: '', next_review_at: '', due: true}], summary: {total: 1, due: 1, available: 0}}};
...
jest.mock('../../src/query/useGrammar', () => ({useGrammarLibrary: () => mockGrammarLibrary, useGrammarLesson: () => mockGrammarLesson, useCompleteGrammarLesson: () => mockGrammarComplete}));
...
const grammarTask = {grammar_id: 'en-articles', title: 'Articles', level: 'B1', target_level: 'B1', prompt: 'Write three sentences.', practice_blueprint: {}, practice_context: {intent: 'repair', focus_category: 'grammar', focus_label: 'Articles', focus_family: 'grammar', task_type: 'story', topic: 'grammar transfer', target_level: 'B1', action_label: 'Practice this grammar', reason: 'A writing finding', evidence: '', focus_instruction: 'Use articles.', grammar_id: 'en-articles', grammar_title: 'Articles'}, source: 'static-grammar-kb'};
