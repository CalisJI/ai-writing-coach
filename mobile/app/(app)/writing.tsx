...
const styles = StyleSheet.create({container: {flexGrow: 1, padding: 24, gap: 12}, title: {fontSize: 28, fontWeight: '700'}, prompt: {fontSize: 16, lineHeight: 24}, input: {minHeight: 220, borderWidth: 1, borderRadius: 12, padding: 14, fontSize: 17}, button: {padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 8}, buttonText: {color: '#fff', fontWeight: '700'}});
