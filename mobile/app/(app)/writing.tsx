...
const styles = StyleSheet.create({container: {flexGrow: 1, padding: 24, gap: 12, width: '100%', maxWidth: CONTENT_MAX, alignSelf: 'center'}, title: {fontSize: 20, fontWeight: '700'}, prompt: {fontSize: 15, lineHeight: 24}, input: {minHeight: 220, borderWidth: 1, borderRadius: 15, padding: 14, fontSize: 15}, button: {padding: 16, borderRadius: 15, alignItems: 'center', minHeight: 44, justifyContent: 'center', marginTop: 8}, buttonText: {fontSize: 14, fontWeight: '700'}});
