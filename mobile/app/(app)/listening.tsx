...
const styles = StyleSheet.create({container: {flexGrow: 1, padding: 24, gap: 12, width: '100%', maxWidth: MAX_CONTENT_WIDTH, alignSelf: 'center'}, title: {fontSize: 28, fontWeight: '700'}, card: {padding: 16, borderRadius: 18, gap: 12, borderWidth: 1}, input: {minHeight: 52, borderWidth: 1, borderRadius: 10, padding: 14, fontSize: 16}, button: {minHeight: 48, padding: 14, borderRadius: 10, borderWidth: 1, alignItems: 'center', justifyContent: 'center'}, actionRow: {gap: 8}, modeRow: {flexDirection: 'row', gap: 8}, mode: {flex: 1, padding: 12, borderWidth: 1, borderColor: 'transparent', borderRadius: 10, alignItems: 'center'}, sectionLabel: {fontSize: 18, fontWeight: '700'}, segmentList: {gap: 8}, segment: {padding: 12, borderWidth: 1, borderRadius: 10}, selectedText: {fontSize: 18, lineHeight: 28}});
