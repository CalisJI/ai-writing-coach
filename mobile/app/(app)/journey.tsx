...
const styles = StyleSheet.create({container: {flexGrow: 1, padding: 24, gap: 12, width: '100%', maxWidth: MAX_CONTENT_WIDTH, alignSelf: 'center'}, title: {fontSize: 28, fontWeight: '700'}, button: {padding: 16, borderRadius: 10, alignItems: 'center', minHeight: 44, justifyContent: 'center', marginTop: 8}, buttonText: {fontSize: 14, fontWeight: '700'}, metrics: {flexDirection: 'row', gap: 8}, metric: {flex: 1, padding: 12, borderRadius: 18, gap: 4}, metricValue: {fontSize: 22, fontWeight: '700'}, card: {padding: 16, borderRadius: 18, gap: 8, borderWidth: 1}, heading: {fontSize: 18, fontWeight: '700'}});
