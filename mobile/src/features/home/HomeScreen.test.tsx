...
jest.mock('../../query/useHome', () => ({useEssays: () => ({data: mockEssays, isPending: false, isError: false}), useLearningMemory: () => ({data: mockMemory, isPending: false, isError: false}), useReadingSessionHistory: () => ({data: mockReadingHistory, isPending: false, isError: false}), useOpenEssay: () => ({isPending: false, isError: false, mutate: jest.fn()}), useCrossSkillCue: () => ({data: undefined, isPending: false, isError: false})}));
