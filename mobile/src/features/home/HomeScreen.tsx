...
const styles = StyleSheet.create({metrics: {flexDirection: 'row', flexWrap: 'wrap', gap: 16}, container: {flex: 1, padding: 24, gap: 12, width: '100%', maxWidth: CONTENT_MAX, alignSelf: 'center'}, title: {fontSize: 20, fontWeight: '700'}, body: {fontSize: 15, lineHeight: 24}, card: {padding: 16, borderRadius: 20, gap: 8, borderWidth: 1}, cardTitle: {fontSize: 15, fontWeight: '700'}, button: {padding: 16, borderRadius: 15, alignItems: 'center', minHeight: 44, justifyContent: 'center', marginTop: 12}, buttonText: {fontSize: 14, fontWeight: '700'}});
