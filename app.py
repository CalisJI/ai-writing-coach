...
from writing_coach.speech_pronunciation import AzureSpeechPronunciationProvider
...
configure_speech_pronunciation(AzureSpeechPronunciationProvider.from_env())
