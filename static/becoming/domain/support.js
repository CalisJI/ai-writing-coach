const COPY={
  vi:{
    ...
    write_intro:'Viết ý thật của bạn trước. Sau khi gửi, BECOMING mới dùng chính bài viết này làm bằng chứng để phân tích.',
    ...
    current_focus_tip:'BECOMING ưu tiên mẫu lỗi có giá trị cải thiện cao nhất thay vì hiển thị mọi lỗi ngang nhau.',
  ...
  en:{
    ...
    write_intro:'Express the real idea first. BECOMING uses the submitted writing itself as the evidence for feedback.',
    ...
    current_focus_tip:'BECOMING prioritizes the most useful recurring pattern instead of treating every detected issue equally.',
  ...
  zh:{
    ...
    write_intro:'先表达真实意思。提交以后，BECOMING 才会把你的文字作为分析证据。',
    ...
    current_focus_tip:'BECOMING 会优先处理最值得改善的重复模式，而不是把所有错误同等显示。',
