...
import {attr,esc,errorBlock,loadingBlock,runBusy,helpTip} from '../components/primitives.js';
        ...
        <div class="o-home-split o-home-split--even">
          <section class="o-card o-panel">
            <div class="o-panel-head">
              <h2 class="o-label">${esc(t('home.recent_drafts'))}</h2>
              <button id="journeyLink" class="text-link" type="button">${esc(t('home.journey'))} &rarr;</button>
            </div>
            ${recentRows(essays)}
          </section>
          ${homeLibrary(library)}
