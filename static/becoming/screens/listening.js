...
export function createListeningController({importMedia,targetLanguage,onChange=()=>{}}){
  const model={status:'empty',payload:null,error:null,selected:null,original:true,meaning:true};
  ...
  return {
    ...
    select(segmentId){model.selected=segmentId;changed();},
