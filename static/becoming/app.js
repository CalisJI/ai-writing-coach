...
import {currentRoute,go,syncNav} from './router.js?v=2.17.1';
...
import {screenContract} from './domain/screen-contract.js?v=2.17.1';
import {applySkillNavigation,routeAvailable} from './domain/skill-release.js?v=2.17.1';
...
import {renderGrammar} from './screens/grammar.js?v=2.17.1';
